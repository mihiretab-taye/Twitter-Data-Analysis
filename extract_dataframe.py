...
class TweetDfExtractor:
    ...
    def find_full_text(self)->list:
        text = [tweet['original_text'] for tweet in self.tweets_list]
    ...
    def find_favourite_count(self)->list:
        favorite_count = [tweet['user']['favorite_count'] for tweet in self.tweets_list]
    ...
    def get_tweet_df(self, save=False)->pd.DataFrame:
        ...
        columns = ['created_at', 'source', 'original_text', 'lang', 'favorite_count', 'retweet_count', 
            'original_author', 'followers_count','friends_count', 'hashtags', 'user_mentions', 'place', 'statuses_count']
        ...
        data = zip(created_at, source, text, lang, fav_count, retweet_count, screen_name, follower_count, friends_count, hashtags, mentions, location, statuses_count)
...
if __name__ == "__main__":
    # required column to be generated you should be creative and add more features
    columns = ['created_at', 'source', 'original_text', 'lang', 'favorite_count', 'retweet_count', 'original_author', 'followers_count','friends_count', 'hashtags', 'user_mentions', 'place', 'statuses_count'] 
